...
12-month outlook, 12pp; TSLA full-desk flagships, 19pp two-column —
all rendered by this engine):
...
**Two-column magazine body — small charts in-column beside running text, heroes spanning both (TSLA dark flagship, 19pp):**

![TSLA dark body](docs/images/showcase-tsla-dark-body.png)

**Same pipeline, light paper — clean tables, gold/teal exhibits (TSLA light flagship):**

![TSLA light body](docs/images/showcase-tsla-light-body.png)

**Matching infographic covers, dark and light — verdict, key cards, scenarios, all on page 1:**

![TSLA dark cover](docs/images/showcase-tsla-dark-cover.png)

![TSLA light cover](docs/images/showcase-tsla-light-cover.png)
...
- `reports/tsla-12m-flagship-dark/` + `reports/tsla-12m-flagship-light/`
  — full-desk TSLA flagships (9,016 words, 28 exhibits, 19pp two-column,
  dark + light). Each ships source (`index.qmd` + `charts/`) and the
  rendered `output/index.pdf` — read the PDF, reproduce from source.
