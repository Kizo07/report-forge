...
def main(argv: list[str] | None = None) -> int:
    ...
    p_new.add_argument("--title-layout", default="hero", choices=["hero", "compact", "minimal"], help="studio/editorial title composition")
    p_new.add_argument("--accent", default=None, help="accent as a six-digit hex color (defaults to the template's own accent)")
